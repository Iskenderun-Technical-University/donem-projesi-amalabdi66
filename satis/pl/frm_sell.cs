...
namespace suaadabdu.pl
{
    ...
    gridControl1.DataSource = dbContext.tb_sell.Local.ToBindingList();
            ...
            if (id > 0)
            {
                ...
                try
                {
                    ...
                    if (rs == DialogResult.Yes)
                    {
                        ...
                        db.SaveChanges();
                        Toast.txt_caption.Text = "satış kaldırıldı";
                        Toast.Show();
                        update_data();
                ...
                {
                   dialog.txt_caption.Text = "silinecek satış yok";
          ...
          void btn_serch_Click()
            {
                ...
                gridControl1.DataSource = db.tb_sell.Where(x => x.sell_cus.Contains(_search) || x.sell__name.Contains(_search) || x.sell__name.Contains(_search)).ToList();
            }
        ...
        {
            var _search = edit_sarch.Text;
            gridControl1.DataSource = db.tb_sell.Where(x => x.sell__name.Contains(_search) || x.sell_cus.Contains(_search) || x.sell_cus.Contains(_search) || x.sell__name.Contains(_search) || x.sell_cus.Contains(_search)).ToList();
